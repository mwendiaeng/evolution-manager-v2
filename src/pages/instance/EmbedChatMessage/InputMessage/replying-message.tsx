...
import { getContactColor, getContactBgColor } from "@/utils/contact-colors";
...
const ReplyingMessage = ({ chat }: { chat?: Contact }) => {
  ...
  const getSenderName = () => {
    ...
    if (
      replyingMessage?.key.participant &&
      replyingMessage?.key.participantPushName
    ) {
      return replyingMessage.key.participantPushName;
    }
