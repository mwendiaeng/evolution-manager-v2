  ...
  const columns: ColumnDef<IntegrationSession>[] = [
    {
      ...
      header: () => (
        <div className="text-center">{t("n8n.sessions.table.remoteJid")}</div>
      ),
    ...
    },
    {
      ...
      header: () => (
        <div className="text-center">{t("n8n.sessions.table.pushName")}</div>
      ),
    ...
    },
    {
      ...
      header: () => (
        <div className="text-center">{t("n8n.sessions.table.sessionId")}</div>
      ),
    ...
    },
    {
      accessorKey: "status",
      header: () => (
        <div className="text-center">{t("n8n.sessions.table.status")}</div>
      ),
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 w-8 p-0">
                <span className="sr-only">
                  {t("n8n.sessions.table.actions.title")}
                </span>
      ...
      >
        ...
        <div>
          <div className="flex items-center justify-between gap-6 p-5">
            <Input
              placeholder={t("n8n.sessions.search")}
              value={globalFilter}
